...
var preload=function(){
    for(var i=1;i<=imageCount;i++){
        var image=new Image();
        image.src='assets/images/animation/animation_{0}.jpg'.format(i);
...
$('.page2 img').attr('src','assets/images/animation/animation_1.jpg').load(function(){
    resizeImage($(this));
    $(this).addClass('loaded');
});
...
var setImage=function(index){
    var src1='assets/images/animation/animation_{0}.jpg'.format(index);
    var src2='assets/images/animation/animation_{0}.jpg'.format(15-index);
